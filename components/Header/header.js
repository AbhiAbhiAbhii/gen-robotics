...
export default function Header({lenis}) {
    ...
    return(
        <>
        <nav ref={navRef} className="nav" style={{position:'fixed' , top:'4%', left:'50%', transform:'translate(-50%,0)', padding:'1.2rem 2rem', width:'90%', zIndex:'9000000', transition:'all 0.6s cubic-bezier(0.25, 1, 0.5, 1)', borderRadius:'0.8rem'}}>
            <div style={{display:'flex', justifyContent:'space-between'}}>
                ...
                <div style={{height:'2.73rem', width:'8.625rem'}}>
                    <img style={{height:'100%', width:'100%', objectFit:'contain'}} src="/logoGenRobo.svg" alt="logo" />
                </div>
                <div style={{display:'flex', alignItems:'center', justifyContent:'center'}}>
                    <button className="btn" style={{color:'#FFF', border:'1px #FFF solid', padding:'1rem 2.4rem', borderRadius:'0.63rem'}}>Talk to us</button>
                </div>
            </div>
        </nav>
        </>
