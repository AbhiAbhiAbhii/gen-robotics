...
export default function ImagePlayProd({ frameCount, imageLinks, travelPixel, texts, title, ImgSeqTitle }) {
    ...
    return <section className="productImgSeq" ref={sectionRef} >
            ...
            <div className="productImgSeq_TextContainer" ref={textContainer}>
                <div style={{position:'relative', height:'100%', width:'100%', zIndex:'100'}}>
                        ...
                        texts && texts.map((t, i) => {
                            return(
                                <div className="prodImg_Seq_Overlay" key={i}>
                                    ...
                                    <div className="prodImg_Seq_Progress" style={{ background:'#757573', position:'relative', borderRadius:'20em'}}>
