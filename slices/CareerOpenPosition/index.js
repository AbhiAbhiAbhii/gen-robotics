            ...
            slice.items.map((data, i) => {
              return(
                <div className="carrOP_Item" key={i}>
                  <div className="carrOP_Item_Inner_Container">
                  ...
                  <PrismicLink className="carrOP_Item_Link" field={data.cta_link}>
                    <div className="carrOP_Item_CTA">
                      <div className="carrOP_Item_InnerCTA_WRAP">
                        ...
                        >Apply Now</button><span style={{position:'relative', transform:'translate(5%, 6%)'}}>
                          <img src="/OpenPosition/OP_Arrow.svg" alt="arrow" /></span>
                      </div>
                    </div>
                  </PrismicLink>
                </div>
